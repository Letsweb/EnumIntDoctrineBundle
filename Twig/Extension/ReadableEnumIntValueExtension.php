...
use Letsweb\Bundle\EnumIntDoctrineBundle\Exception\ValueIsFoundInFewRegisteredEnumTypesException;
use Letsweb\Bundle\EnumIntDoctrineBundle\Exception\ValueIsNotFoundInAnyRegisteredEnumTypeException;
 ...
 */
class ReadableEnumIntValueExtension extends AbstractEnumIntExtension
{
    /**
     * {@inheritdoc}
     */
    ...
    public function getReadableEnumValue($enumValue, $enumType = null)
    {
        if (!empty($this->registeredEnumTypes) && is_array($this->registeredEnumTypes)) {
            ...
            if (!empty($enumType)) {
                ...
                /** @var $enumTypeClass \Letsweb\Bundle\EnumIntDoctrineBundle\DBAL\Types\AbstractEnumIntType */
